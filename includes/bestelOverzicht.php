...
$queryResult = getOrders();
//var_dump($queryResult);


// header line
fputs($fs, str_pad( "bestelling",25, " ") . str_pad( "achternaam",25, " ") . str_pad( "product",15, " ") . str_pad( "aantal",15, " ") . "\n"  );
fputs($fs, str_pad( "",80, "=") . "\n" );
...
// aanmaken PDF output  uit textfile
$pdf=new PDF();

$pdf->Open();
$title='bestellingen';
$pdf->SetTitle($title);
$pdf->SetAuthor('Baatti');
